...
for kordx = 1.0:1:sizx
        for kordy = 1.0:1:sizy
            ...
            if     f1 > -koef_sp+f2 && f1 > -koef_sp+f3 && f1 > -koef_sp+f4 && f1 > -koef_sp+f5 ...
                && f2 > -koef_sp+f1 && f2 > -koef_sp+f3 && f2 > -koef_sp+f4 && f2 > -koef_sp+f5 ...
                && f3 > -koef_sp+f1 && f3 > -koef_sp+f2 && f3 > -koef_sp+f4 && f3 > -koef_sp+f5 ...
                && f4 > -koef_sp+f1 && f4 > -koef_sp+f2 && f4 > -koef_sp+f3 && f4 > -koef_sp+f5 ...
                && f5 > -koef_sp+f1 && f5 > -koef_sp+f2 && f5 > -koef_sp+f3 && f5 > -koef_sp+f4

                img_compared(kordx,kordy)=f1/5+f2/5+f3/5+f4/5+f5/5;
                a=a+1;
            else
            end
