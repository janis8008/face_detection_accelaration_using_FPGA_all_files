...
for kordx = 1.0:1:sizx
        for kordy = 1.0:1:sizy
            ...
            if     f1 > koef*f2 && f1 > koef*f3 && f1 > koef*f4 && f1 > koef*f5 ...
                && f2 > koef*f1 && f2 > koef*f3 && f2 > koef*f4 && f2 > koef*f5 ...
                && f3 > koef*f1 && f3 > koef*f2 && f3 > koef*f4 && f3 > koef*f5 ...
                && f4 > koef*f1 && f4 > koef*f2 && f4 > koef*f3 && f4 > koef*f5 ...
                && f5 > koef*f1 && f5 > koef*f2 && f5 > koef*f3 && f5 > koef*f4
            
            
                img_grey11(kordx,kordy)=(f1/5+f2/5+f3/5+f4/5+f5/5)*1;
                a=a+1;
            else
                img_grey11(kordx,kordy)=img_grey1(kordx,kordy)*0;
            end         
        end
end
a
